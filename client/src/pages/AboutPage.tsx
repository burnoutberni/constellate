		...
		<div className="min-h-screen bg-neutral-100">
			...
			<div className="bg-white border-b border-neutral-200">
				<div className="max-w-4xl mx-auto px-4 py-16 text-center">
					<h1 className="text-5xl font-bold text-neutral-900 mb-4">Constellate</h1>
				...
				<section>
					...
					<ul className="space-y-3 text-lg text-neutral-700">
						<li className="flex items-start gap-3">
							...
							<span>
								<strong>Freedom:</strong> Choose your own server or run your own
								instance
							</span>
						</li>
						<li className="flex items-start gap-3">
							<span className="text-2xl">🔗</span>
							<span>
								<strong>Interoperability:</strong> Connect with users across
								different servers using ActivityPub
							</span>
						</li>
						<li className="flex items-start gap-3">
							<span className="text-2xl">🛡️</span>
							<span>
								<strong>Resilience:</strong> No single point of failure - the
								network survives even if one server goes down
							</span>
						</li>
						<li className="flex items-start gap-3">
							<span className="text-2xl">👥</span>
							<span>
								<strong>Community:</strong> Each server is owned and operated by its
								community
							</span>
						</li>
					</ul>
