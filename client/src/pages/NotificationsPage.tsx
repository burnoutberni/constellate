        ...
        if (isError) {
            return (
                <Card variant="elevated" padding="lg" className="text-center">
                    <p className="text-lg font-semibold text-text-primary mb-2">Unable to load notifications</p>
    ...
    return (
        <div className="min-h-screen bg-background-secondary">
            ...
            <Container size="lg" className="py-10 space-y-6">
                ...
                {!user && (
                    <Card variant="elevated" padding="lg" className="text-center">
                        <h2 className="text-xl font-semibold text-text-primary mb-2">Sign in to view notifications</h2>
