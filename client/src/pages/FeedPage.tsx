...
export function FeedPage() {
	...
	// Bolt: Memoize raw items to prevent unnecessary processing
	const allItems = useMemo(
		() => data?.pages?.flatMap((page: { items: FeedItem[], nextCursor?: string }) => page.items) || [],
		[data]
	)

	// Bolt: Memoize validated items to ensure stable object references and avoid re-running validation
