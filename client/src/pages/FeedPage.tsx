...
export function FeedPage() {
	...
	// Bolt: Memoize feed items and validation to prevent expensive re-validation on every render
						...
						{feedItems.length === 0 ? (
							...
							feedItems.map((item) => {
								...
								switch (item.type) {
									...
									case 'onboarding': {
										const validatedData = validated as z.infer<typeof SuggestedUsersSchema>
									...
									case 'trending_event': {
										const validatedData = validated as z.infer<typeof EventSchema>
										return (
									...
									case 'activity': {
										const validatedData = validated as z.infer<typeof ActivitySchema>
