					...
					<div className="space-y-6" style={{ overflowAnchor: 'none' }}>
						...
						{feedContent.length === 0 ? (
							...
							feedContent.map((item) => {
								if (!item.validatedData) { return null }

								switch (item.type) {
									case 'header': {
										// eslint-disable-next-line @typescript-eslint/no-explicit-any
										const { title } = item.validatedData as any
										return (
									...
									case 'onboarding': {
										// eslint-disable-next-line @typescript-eslint/no-explicit-any
										const { suggestions } = item.validatedData as any
									...
									case 'trending_event': {
										// eslint-disable-next-line @typescript-eslint/no-explicit-any
										const event = item.validatedData as any
										return (
									...
									case 'activity': {
										// eslint-disable-next-line @typescript-eslint/no-explicit-any
										const activity = item.validatedData as any
