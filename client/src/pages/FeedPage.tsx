...
export function FeedPage() {
	...
	const validatedItems = useMemo(() => {
		// Memoize validation to prevent expensive schema parsing on unrelated re-renders
						...
						{validatedItems.length === 0 ? (
							...
							validatedItems.map((item) => {
								...
								switch (item.type) {
									...
									case 'onboarding': {
										const itemData = validatedData as z.infer<typeof SuggestedUsersSchema>
									...
									case 'trending_event': {
										const event = validatedData as z.infer<typeof EventSchema>
										return (
									...
									case 'activity': {
										const activity = validatedData as z.infer<typeof ActivitySchema>
