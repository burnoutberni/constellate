...
// Bolt: Memoized to prevent unnecessary re-renders when parent list updates but this item hasn't changed
export const ActivityFeedItem = memo(({ activity }: ActivityFeedItemProps) => {
