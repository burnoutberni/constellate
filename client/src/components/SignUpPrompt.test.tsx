...
describe('SignUpPrompt Component', () => {
  describe('Legacy API (with SignupModal)', () => {
    it('should render with default action text', () => {
      renderWithRouter(<SignUpPrompt className="" />)
    ...
    it('should render with custom action text', () => {
      renderWithRouter(<SignUpPrompt action="follow this user" className="" />)
    ...
    it('should render with custom message', () => {
      ...
      renderWithRouter(<SignUpPrompt message={customMessage} className="" />)
