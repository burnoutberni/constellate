						...
						(onRightIconClick ? (
							<button
								...
								className={cn(
									...
									'text-text-disabled transition-colors hover:text-text-primary',
									'focus:outline-none focus:text-primary-600 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 rounded-sm',
									error && 'text-error-500 dark:text-error-400'
								)}>
								{rightIcon}
							</button>
