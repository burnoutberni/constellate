        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-text-tertiary mt-1">
              Email changes are not yet supported. Contact your instance administrator if you need to
              change your email.
            </p>
          </div>
          ...
          {/* Delete Account */}
          <div className="border-t border-border-default pt-6">
            <h3 className="font-medium text-error-600 dark:text-error-400 mb-2">Danger Zone</h3>
            <p className="text-sm text-text-tertiary mb-4">
            ...
            {!showDeleteConfirm ? (
              ...
              <div className="space-y-4 bg-error-50 dark:bg-error-950 p-4 rounded-lg border border-error-200 dark:border-error-800">
                ...
                <Input
                  ...
                  error={deleteConfirmText !== '' && deleteConfirmText !== profile.username}
                />
