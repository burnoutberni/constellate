...
export function SearchBar() {
	...
	const rightIcon = isLoading ? (
		...
		<button
			onClick={handleClear}
			className="text-text-tertiary hover:text-text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus:text-text-primary p-1 rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
