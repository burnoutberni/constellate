      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            <Link to={user ? '/feed' : '/'} className="text-2xl font-bold text-info-600">
              Constellate
            </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            {user ? (
              <>
                {isAdmin && (
                  <Link to="/admin" className="text-sm text-neutral-700 hover:text-neutral-900">
                    Admin
                  </Link>
                )}
                <Link to="/settings" className="text-sm text-neutral-700 hover:text-neutral-900">
                  Settings
                </Link>
                <Link to="/reminders" className="text-sm text-neutral-700 hover:text-neutral-900">
                  Reminders
                </Link>
                <Link to="/followers/pending" className="text-sm text-neutral-700 hover:text-neutral-900">
                  Followers
                </Link>
