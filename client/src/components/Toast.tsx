...
function ToastItem({ toast, variant, onDismiss }: ToastItemProps) {
	...
	const variantStyles = {
		error: {
			container:
				'rounded-lg border border-error-200 bg-error-50 dark:bg-error-950 dark:border-error-800 p-4 shadow-xl',
		...
		success: {
			container:
				'rounded-lg border border-success-200 bg-success-50 dark:bg-success-950 dark:border-success-800 p-4 shadow-xl',
