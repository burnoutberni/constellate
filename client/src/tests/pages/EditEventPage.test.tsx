...
describe('EditEventPage', () => {
    ...
    it('should handle recurrence pattern selection', async () => {
        ...
        const recurrenceSelect = recurrenceLabel.parentElement?.querySelector('select') as HTMLSelectElement
    ...
    it('should handle visibility selection', async () => {
        ...
        const visibilitySelect = visibilityLabel.parentElement?.querySelector('select') as HTMLSelectElement
    ...
    it('should clear coordinates', async () => {
        ...
        await waitFor(() => {
            ...
            const latInput = latLabel.parentElement?.querySelector('input[type="text"]') as HTMLInputElement
