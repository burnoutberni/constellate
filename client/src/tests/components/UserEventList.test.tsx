...
describe('UserEventList Component', () => {
	it('should render event list with events', () => {
		render(<UserEventList events={mockEvents} onEventClick={vi.fn()} />)
	...
	it('should call onEventClick when event card is clicked', () => {
		...
		render(<UserEventList events={mockEvents} onEventClick={onEventClick} />)
	...
	it('should display empty state when no events', () => {
		render(<UserEventList events={[]} onEventClick={vi.fn()} />)
	...
	it('should handle events without counts gracefully', () => {
		...
		render(<UserEventList events={eventsWithoutCounts} onEventClick={vi.fn()} />)
	...
	it('should format dates correctly', () => {
		render(<UserEventList events={[mockEvents[0]]} onEventClick={vi.fn()} />)
