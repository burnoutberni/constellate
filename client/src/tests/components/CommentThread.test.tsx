...
describe('CommentThread Component', () => {
	...
	it('should show reply button when onReply is provided and depth allows', () => {
		render(
			<BrowserRouter>
				<CommentThread comment={mockComment} onReply={vi.fn()} depth={0} />
			</BrowserRouter>
		)
	...
	it('should not show reply button when depth is 2 or more', () => {
		render(
			<BrowserRouter>
				<CommentThread comment={mockComment} onReply={vi.fn()} depth={2} />
			</BrowserRouter>
		)
	...
	it('should show delete button for comment owner', () => {
		render(
			<BrowserRouter>
				<CommentThread comment={mockComment} currentUserId="user1" onDelete={vi.fn()} />
			</BrowserRouter>
		)
	...
	it('should not show delete button for other users', () => {
		render(
			<BrowserRouter>
				<CommentThread comment={mockComment} currentUserId="user999" onDelete={vi.fn()} />
			</BrowserRouter>
		)
