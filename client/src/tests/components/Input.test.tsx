...
describe('Input Component', () => {
	...
	it('should render error message when error and errorMessage are provided', () => {
		render(<Input type="text" error errorMessage="This field is required" />)
	...
	it('should not show helper text when error is present', () => {
		render(<Input type="text" error errorMessage="Error message" helperText="Helper text" />)
	...
	it('should render left icon when provided', () => {
		render(<Input type="text" leftIcon={<span>🔍</span>} />)
	...
	it('should render right icon when provided', () => {
		render(<Input type="text" rightIcon={<span>✓</span>} />)
	...
	it('should not render right icon as button if handler is missing', () => {
		render(<Input type="text" rightIcon={<span>X</span>} />)

		const iconContainer = screen.getByText('X').parentElement
