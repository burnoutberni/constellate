...
import { isSafeNavigationUrl, safeNavigate } from './urlValidation'
...
describe('isSafeNavigationUrl', () => {
    ...
    describe('invalid/malicious URLs', () => {
        ...
        it('blocks invalid input', () => {
            ...
            expect(isSafeNavigationUrl(123 as any)).toBe(false)
            expect(isSafeNavigationUrl({} as any)).toBe(false)
        })
