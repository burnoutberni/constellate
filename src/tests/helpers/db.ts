 ...
 * Create a test like
 */
export async function createTestLike(data: { userId: string; eventId: string }) {
 ...
 */
export async function createTestFollow(data: { followerId: string; followingId: string }) {
