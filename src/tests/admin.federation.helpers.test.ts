...
describe('Admin Federation Helper Functions', () => {
    ...
    describe('getDomainStats', () => {
        ...
        it('should aggregate stats by domain from multiple deliveries', () => {
            const deliveries = [
                { inboxUrl: 'https://example.com/inbox1', status: 'FAILED' as FailedDeliveryStatus },
                { inboxUrl: 'https://example.com/inbox2', status: 'DISCARDED' as FailedDeliveryStatus },
        ...
        it('should skip invalid URLs without breaking the aggregation', () => {
            const deliveries = [
                ...
                { inboxUrl: 'https://other.com/inbox', status: 'DISCARDED' as FailedDeliveryStatus },
        ...
        it('should not count RETRYING status in success or failed', () => {
            const deliveries = [
                { inboxUrl: 'https://example.com/inbox1', status: 'RETRYING' as FailedDeliveryStatus },
                { inboxUrl: 'https://example.com/inbox2', status: 'RETRYING' as FailedDeliveryStatus },
            ]
        ...
        it('should aggregate complex mix of statuses correctly', () => {
            const deliveries = [
                { inboxUrl: 'https://mastodon.social/inbox', status: 'FAILED' as FailedDeliveryStatus },
                { inboxUrl: 'https://mastodon.social/users/alice/inbox', status: 'FAILED' as FailedDeliveryStatus },
                { inboxUrl: 'https://mastodon.social/users/bob/inbox', status: 'DISCARDED' as FailedDeliveryStatus },
                { inboxUrl: 'https://mastodon.social/users/carol/inbox', status: 'RETRYING' as FailedDeliveryStatus },
                { inboxUrl: 'https://pixelfed.social/inbox', status: 'PENDING' as FailedDeliveryStatus },
                { inboxUrl: 'https://pixelfed.social/users/dave/inbox', status: 'DISCARDED' as FailedDeliveryStatus },
                { inboxUrl: 'https://pixelfed.social/users/eve/inbox', status: 'DISCARDED' as FailedDeliveryStatus },
            ]
