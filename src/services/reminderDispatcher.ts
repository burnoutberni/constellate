...
async function sendReminderEmail(
	reminder: NonNullable<ReminderWithContext>,
	context: { reminderLabel: string; eventUrl: string; eventStartFormatted: string }
) {
...
async function finalizeReminder(
	reminder: NonNullable<ReminderWithContext>,
	notificationResult: Awaited<ReturnType<typeof sendReminderNotification>>,
